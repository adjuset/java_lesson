...
public interface InterfaceA {
	 ...
	 *    자바인터페이스의 특징
	 *   1. 객체를 직접 생성하지 않습니다.
	 *   2. 필드는 상수만 있습니다.		   public static final 생략합니다.	(인스턴스 필드 없음)
	 ...
	 */
			...
			//인터페이스를 사용하는 기존 애클리케이션과 호환을 위해서
			//추가적인 기능은 디폴트 메소드로 정의해서 사용함.
			default void methodD(String message) {		// 디폴트 인스턴스 메소드 : 재정의로 사용하기 위해 만들어짐
